...
<template>
  <section class="page">
    ...
    <form class="create" @submit.prevent="create">
      ...
      <Button
        type="submit"
        :label="creating ? t('vendors.adding') : t('vendors.add')"
        ...
        <Column :header="t('categories.published')" style="width: 7rem">
          <template #body="{ data }">
            <ToggleSwitch
              ...
              @update:modelValue="togglePublished(data)"
