...
<template>
  <section>
    <header class="page">
      ...
      <RouterLink class="btn btn--primary" to="/admin/products">Manage products</RouterLink>
    </header>
    ...
    <div class="card">
      <div class="card__head">
        ...
        <RouterLink v-if="canAudit" class="card__link" to="/admin/audit">View all</RouterLink>
      </div>
