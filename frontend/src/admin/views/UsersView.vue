...
.search { display: flex; gap: var(--space-2); margin-bottom: var(--space-4); }
.search .grow { flex: 1; }
...
.assign { display: flex; gap: var(--space-2); align-items: center; }
.empty { padding: var(--space-4); color: var(--color-text-muted); }
h3 { font-size: var(--text-sm); text-transform: uppercase; letter-spacing: 0.04em; color: var(--color-text-muted); margin: var(--space-4) 0 var(--space-2); }
</style>
