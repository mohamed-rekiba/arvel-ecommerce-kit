...
.brand .mk { width: 30px; height: 30px; border-radius: 9px; background: var(--amber-500); display: grid; place-items: center; color: var(--ink-900); font-weight: 800; }
...
.item.router-link-active::before { content: ""; position: absolute; left: 0; top: 6px; bottom: 6px; width: 3px; border-radius: 0 3px 3px 0; background: var(--amber-500); }
...
.av { width: 34px; height: 34px; border-radius: 999px; background: linear-gradient(140deg, var(--amber-500), var(--amber-600)); color: var(--ink-900); display: grid; place-items: center; font-weight: 700; }
...
.me__out { align-self: flex-start; border: 0; background: none; padding: 0; color: var(--amber-600); font: inherit; font-size: 11px; cursor: pointer; }
