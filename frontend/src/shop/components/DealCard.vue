...
<template>
  <article class="deal">
    <RouterLink
      ...
      :aria-label="product.translation.name"
    >
    ...
    <div class="deal__info">
      ...
      <div class="deal__stock">
        <div class="deal__stockrow">
          <span
            >{{ t('deal.available') }}: <b>{{ deal.available }}</b></span
          >
          <span
            >{{ t('deal.sold') }}: <b>{{ deal.sold }}</b></span
          >
        </div>
        <div
          class="deal__bar"
...
[data-theme='dark'] .deal__media img {
