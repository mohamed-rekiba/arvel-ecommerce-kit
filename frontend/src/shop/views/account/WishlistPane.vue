  ...
  <div class="card">
    <div class="head">
      ...
      <div v-if="rows.length" class="head__actions">
        <button class="cta cta--sm" :disabled="bulkBusy" @click="addAll">
          {{ t('account.wl_add_all') }}
        </button>
        <button class="ghost" :disabled="bulkBusy" @click="clearAll">
          {{ t('account.wl_clear') }}
        </button>
      </div>
    </div>
      ...
      <table class="tbl">
        <thead>
          <tr>
            ...
            <th>
              <span class="sr">{{ t('account.wl_remove') }}</span>
            </th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="p in rows" :key="p.id">
            ...
            <td>
              <button class="x" :aria-label="t('account.wl_remove')" @click="removeOne(p)">
                ✕
              </button>
            </td>
          </tr>
