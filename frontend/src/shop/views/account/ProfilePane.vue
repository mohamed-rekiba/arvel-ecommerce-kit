...
<template>
  <div v-if="state.customer" class="card">
    ...
    <div class="ava">
      <span class="ava__img">
        ...
        >
          <svg viewBox="0 0 24 24">
            <path d="M4 8h3l2-2h6l2 2h3v11H4zM12 17a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4Z" />
          </svg>
        </button>
      ...
      <div class="ava__meta">
        ...
        <i>
          ...
          <span v-if="state.customer.email_verified" class="ok-badge"
            >✓ {{ t('account.verified') }}</span
          >
        </i>
    ...
    <p v-if="!state.customer.email_verified" class="verify" role="status">
      ...
      <button v-if="!resent" class="link" @click="resendVerification">
        {{ t('account.resend') }}
      </button>
    ...
    <form class="form" @submit.prevent="saveProfile">
      ...
      <label class="field field--wide">
        <span
          >{{ t('account.phone') }} <em>{{ t('account.phone_hint') }}</em></span
        >
